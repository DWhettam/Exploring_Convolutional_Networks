...
class ConvolutionalNetwork(nn.Module):
    def __init__(self, input_shape, dim_reduction_type, stride, dilation, dropout, num_output_classes, num_filters, num_layers, use_bias=False):
        """
    ...
    def build_module(self):
        ...
        for i in range(self.num_layers):  # for number of layers times
            ...
            if self.dropout:
                self.layer_dict['dropout_{}'.format(i)] = nn.Dropout2d(p=0.2)
