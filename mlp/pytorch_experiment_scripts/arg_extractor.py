...
def get_args():
    ...
    parser.add_argument('--stride', nargs="?", type=int, default=1,
                        help='Stride Parameter')
    parser.add_argument('--dilation', nargs="?", type=int, default=2, 
                        help='Dilation Parameter')
    parser.add_argument('--dropout', nargs="?", type=bool, default=False,
                        help='Dilation Parameter')
